...
exports.buscarviaje = async (req, res) => {
  try {
    ...
    const sql2 = `SELECT v.id_Viaje, v.id_Vehiculo, v.id_Personal, v.cantidad, v.id_SedeOrigen, v.id_SedeDestino, v.id_Status, v.carga, v.detalle,
...
exports.modify = async (req, res) => {
  ...
  sql = `UPDATE viajes SET ? WHERE id_Viaje = ${viaje}`
  try {
      ...
      if (err) {
        ...
        if (req.body.fchhoraestimada_Carga !== '' || req.body.fchhoraestimada_Carga !== null) {
          try {
            ...
            sql2 = `UPDATE detalle_evento SET fchhoraestimada_Llegada = '${fechaCarga}' WHERE id_Viaje = ${viaje} AND id_Evento = 2`
        ...
        if (req.body.fchhoraestimada_Descarga !== '' || req.body.fchhoraestimada_Descarga !== null) {
          try {
            ...
            sql3 = `UPDATE detalle_evento SET fchhoraestimada_Llegada = '${fechaDescarga}' WHERE id_Viaje = ${viaje} AND id_Evento = 3`
